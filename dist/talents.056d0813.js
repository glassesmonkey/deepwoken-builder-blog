...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/builder/talents.js":[function(require,module,exports) {
var selectedTalents = {};
window.selectedTalents = window.selectedTalents || {};
function initializeTalentsTab() {
  window.selectedTalents = window.selectedTalents || {};
  var talentCategories = document.querySelectorAll('#available-talents > .mb-4 > .talent-category');
  var talentItems = document.querySelectorAll('#available-talents .talent-list li');
  talentCategories.forEach(function (button) {
...
function updateSelectedTalents() {
  var selectedTalentsDiv = document.getElementById('selected-talents');
  var categories = ['Common', 'Rare', 'Advanced', 'Oath'];
  ...
  categories.forEach(function (category, index) {
    var talents = window.selectedTalents[category] || [];
    innerHTML += "\n        <div class=\"talent-category\">\n          <div class=\"flex justify-between items-center mb-2\">\n            <span class=\"text-lg font-semibold text-gray-300\">".concat(category, "</span>\n            <span class=\"text-lg font-bold text-").concat(colors[index], "-400\">").concat(talents.length, "</span>\n          </div>\n          <ul class=\"list-disc list-inside text-gray-400 space-y-1\">\n            ").concat(talents.map(function (talent) {
      return "<li>".concat(talent, "</li>");
    }).join(''), "\n          </ul>\n        </div>\n      ");
  });
  innerHTML += '</div>';
...
},{}]},{},["C:/Users/Administrator/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/builder/talents.js"], null)
//# sourceMappingURL=/talents.056d0813.js.map